...
export type TemplateType = "EDDMTWR" | "EDDNTWR" | "EDDPTWR" | "EDDPAPP" | "APP" | "CTR";
...
export const TemplateConfig: Record<TemplateType, TemplateSettings> = {
  ...
  EDDPAPP: {
    Templatename: "APP EDDP",
    displayName: "Approach (EDDP)",
    templatePath: "/banner/cpt-template/EDDP/APP/EmptyTemplateV1.png",
