  ...
  try {
    ...
    const config = await prisma.weeklyEventConfiguration.create({
      data: {
        ...
        airports: parsed.data.airports ? JSON.stringify(parsed.data.airports) : null,
        startTime: parsed.data.startTime || null,
        endTime: parsed.data.endTime || null,
        description: parsed.data.description || null,
        minStaffing: parsed.data.minStaffing ?? 0,
        requiresRoster: parsed.data.requiresRoster ?? false,
        staffedStations: parsed.data.staffedStations ? JSON.stringify(parsed.data.staffedStations) : null,
